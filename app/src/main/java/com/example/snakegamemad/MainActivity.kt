package com.example.snakegamemad
...
class MainActivity : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val prefs by lazy { getSharedPreferences("SnakeGame", Context.MODE_PRIVATE) }
            ...
            fun checkFoodCollision() {
                ...
                if (distance < distanceThreshold) { // Check if the distance between the snake head and the meat is less than the threshold
                    ...
                    if (scorex > highScore) {
                        ...
                        // Update UI or show a message indicating a new high score
                    }
